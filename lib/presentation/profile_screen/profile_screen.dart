...
class ProfileScreen extends GetWidget<ProfileController> {
  ...
  Widget _buildProfileDetails() {
    return Column(children: [
      CustomImageView(imagePath: ImageConstant.imgProfileThumbnail, height: 97.adaptSize, width: 97.adaptSize, radius: BorderRadius.circular(48.h)),
      SizedBox(height: 12.v),
      Text("lbl_erlik_bachman".tr, style: theme.textTheme.titleMedium),
      SizedBox(height: 4.v),
      Text("msg_bachman_mail_com".tr, style: CustomTextStyles.bodyMediumOnPrimaryContainer)
    ]);
  }
  ...
  Widget _buildThirtyNine() {
    return Container(
        ...
        decoration: AppDecoration.fillPrimaryContainer.copyWith(borderRadius: BorderRadiusStyle.roundedBorder9),
        child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, children: [
          Text("lbl_my_subscription".tr, style: theme.textTheme.bodyLarge),
          SizedBox(height: 8.v),
          Text("msg_valid_until_may".tr, style: CustomTextStyles.bodyMediumOnPrimaryContainer)
        ]));
  }
